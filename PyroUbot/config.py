...
LOGS_MAKER_UBOT = int(os.getenv("LOGS_MAKER_UBOT", "-1001909752419"))

BLACKLIST_CHAT = list(map(int, os.getenv("BLACKLIST_CHAT", "-1001538826310 -1001462256506 -1001812143750 -1002012397923").split()))
