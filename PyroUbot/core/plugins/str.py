...
async def ping_cmd(client, message):
    ...
    emot_1 = await get_list_from_vars(client.me.id, "EMOJI_PING")
    emot_2 = await get_list_from_vars(client.me.id, "EMOJI_MENTION")
...
<b><emoji id={emot_mention}>👑</emoji>ᴍᴇɴᴛɪᴏɴ:</b> <code>𝘊𝘰𝘯𝘴𝘵𝘦𝘳𝘭𝘺𝘹𝘉𝘰𝘵</code>
"""
    else:
        _ping = f"""
